...
from src.backend.core.config import HINT_THRESHOLDS, LETTER_GIFS_DIR
...
class TutorialManager:
    ...
    def should_show_hint(self, attempt_count: int, hints_shown: int, max_hints: int) -> bool:
        ...
        # Thresholds come from HINT_THRESHOLD_ATTEMPTS in core config. They used
        # to be a hardcoded [5, 10, 15] that ignored the configured value and
        # contradicted the documented behaviour.
        return attempt_count in HINT_THRESHOLDS
